package com.example.class_exercise_1.Dhishamodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class DhishaChildren {
     @Id
     private int babyId;
     ...
     public DhishaChildren() {

     }

     public DhishaChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
